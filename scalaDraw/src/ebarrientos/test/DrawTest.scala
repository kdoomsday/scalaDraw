...
//    p add (Rectangle(10, 10, 20, 40), Point(15, 15), r1, r2)
    ...
    p add (Line(100, 25, 100, 175, Color.BLACK), Line(25, 100, 175, 100, Color.BLACK))
...
//    p add (TransformedShape(FilledRect((50.0, 50.0), (100.0, 100.0)),
//        (new AffineTransform2d() scalex 2) rotate (scala.math.Pi/4)))
    
    p add (TransformedShape(FilledRect((50.0, 50.0), (100.0, 100.0)),
        (new AffineTransform2d() rotate (scala.math.Pi/4))))
    
    p add (Rectangle(100, 50, 200, 100))
  ...
  private def doKeys(c: Char) = c match {
    ...
    case 'p' => p.currentShapes foreach println
